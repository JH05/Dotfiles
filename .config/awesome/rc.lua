...
-- beautiful module initialization
...
-- Window gaps
beautiful.useless_gap = 2          -- desired gap distance
beautiful.gap_single_client = true -- gaps with only one window
...
clientkeys = gears.table.join(
    ...
    --awful.key({                   }, "f5", 
    --    function ()
    --    awful.util.spawn("brightness --device'smc::kbd_backlight' set 25%-")
    --    end)
)
